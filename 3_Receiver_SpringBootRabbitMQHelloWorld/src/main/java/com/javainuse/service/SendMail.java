...
// // Setup mail server
// properties.put("mail.smtp.host",host);properties.put("mail.smtp.port","465");properties.put("mail.smtp.ssl.enable","true");properties.put("mail.smtp.auth","true");
...
// // Send message
// Transport.send(message);System.out.println("Sent message
// successfully....");}catch(
